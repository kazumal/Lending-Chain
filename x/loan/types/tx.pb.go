...
func init() {
	proto.RegisterType((*MsgRequestLoan)(nil), "kazumal.loan.loan.MsgRequestLoan")
	proto.RegisterType((*MsgRequestLoanResponse)(nil), "kazumal.loan.loan.MsgRequestLoanResponse")
}
...
var fileDescriptor_b8f8f93b4237d328 = []byte{
	...
	0xd3, 0x2f, 0xa9, 0xd0, 0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x17, 0x12, 0xcc, 0x4e, 0xac, 0x2a, 0xcd,
	0x4d, 0xcc, 0xd1, 0x03, 0x09, 0x83, 0x09, 0xa5, 0x09, 0x8c, 0x5c, 0x7c, 0xbe, 0xc5, 0xe9, 0x41,
	...
	0x0f, 0xd5, 0x00, 0x29, 0x4d, 0x82, 0x4a, 0x60, 0x76, 0x38, 0xd9, 0x9d, 0x78, 0x24, 0xc7, 0x78,
	...
	0xae, 0x3e, 0xd4, 0x38, 0x7d, 0x70, 0xf8, 0x56, 0x40, 0xa8, 0x92, 0xca, 0x82, 0xd4, 0xe2, 0x24,
	0x36, 0x70, 0x50, 0x1b, 0x03, 0x02, 0x00, 0x00, 0xff, 0xff, 0x15, 0xf1, 0x8f, 0x1a, 0x7b, 0x01,
	0x00, 0x00,
}
...
func (c *msgClient) RequestLoan(ctx context.Context, in *MsgRequestLoan, opts ...grpc.CallOption) (*MsgRequestLoanResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/kazumal.loan.loan.Msg/RequestLoan", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_RequestLoan_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/kazumal.loan.loan.Msg/RequestLoan",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "kazumal.loan.loan.Msg",
